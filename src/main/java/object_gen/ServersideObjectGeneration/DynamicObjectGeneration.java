            ...
            String database, String packageName, String OUTPUT_PACKAGE)
    {
        try
        {
            ...
            if (data_store.toLowerCase().equals("mongodb"))
            {
                ...
                EntityManagerFactory emf = Persistence.createEntityManagerFactory("mongodatabase_pu",
                ...
                Integer noOfCollections = (int) Double.parseDouble(((MongoDBClient) client).executeScript(jScript)
                        .toString());
            ...
            else if (data_store.toLowerCase().equals("cassandra"))
            {
                ...
                EntityManagerFactory emf = Persistence
                        .createEntityManagerFactory("cassandra_pu", connnectionProperties);
